...
import { MapPin, Phone, MessageCircle, Mail, Send, Clock, CheckCircle2, AlertCircle } from "lucide-react";
import { submitContactForm } from "@/lib/contactHelpers";
...
export default function ContactoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage(
        "Hubo un problema al enviar el mensaje. Por favor intentá nuevamente o escribinos por WhatsApp."
      );
    } finally {
              ...
              <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-primary to-accent text-white rounded-xl transition-all font-semibold ${
                      isSubmitting
